...
class Car():
    ...
    # constructor
    def __new__(cls, *args):  # new obj ni yasash uchun
        print("* __new__ *")
    ...
    def __str__(self):  # obj ni print qilganda biz xoxlagan string chiqishi uchun
        return f"{self.name} was produced in {self.year} year!"

    def __call__(self):  # functionlardek call qilish uchun
